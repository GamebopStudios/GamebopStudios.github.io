...
function updateMenu() {
	...
	document.getElementById('playerGold').innerHTML = "Gold:" + data.player.gold;
    document.getElementById('playerSilver').innerHTML = "Silver:" + data.player.silver;
    document.getElementById('playerBronze').innerHTML = "Bronze:" + data.player.bronze;
...
function saveTXT() {
    ...
    downloadLink.download = "TU "+date+".tentacle";
...
function switchDesc(n) {
	if (n != "player") {
		...
		<h2 class = "selfDesc lb_Name char_player">`+data.player.name+`</h2>
			...
			<p class = "selfDesc">Gold: $`+data.player.gold+`</p>
			<p class = "selfDesc">Silver: $`+data.player.silver+`</p>
			<p class = "selfDesc">Bronze: $`+data.player.bronze+`</p>
