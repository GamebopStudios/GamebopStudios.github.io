...
function writeEncounter(scene) {
	...
	switch (scene) {
		...
		case "start" : {
			...
			writeCenteredText("Tentacle Universe is an adult game created by <b><u>xEmmy</u></b> and inspired by <b><u>xEmma</u></b>. This game was created and is maintained by <a href='https://gamebopstudios.github.io'>Gamebop Studios</a>.");
			writeCenteredText("This is the first game Developed by Gamebop Studios. Gamebop studios is working on a Minecraft Sex Mod called A Lewd Start. The discord for it is Here: <a href='https://discord.gg/AtdBE5z4Ub'>A Lewd Start Community Server</a>");
		...
		case "prologue": {
			writeText("Input your name <input type='text' id='nameSubmission' value='Dark Mage'>");
			writeFunction("renamePlayer()", "You see a bright flash and you Pop into the world");
			break;
		}
		case "prologueAlt": {
